    ...
    <>
        <Section id="contact" className="bg-[#4a5f9d]">
            ...
            <div className="space-y-8">
                ...
                <div className="text-white space-y-1">
                    <a href="mailto:heart.soccer.agent@gmail.com" className="hover:text-[#c8e86f] transition-colors block">
                    heart.soccer.agent@gmail.com
                    </a>
                    <a href="mailto:justin.swhong2@gmail.com" className="hover:text-[#c8e86f] transition-colors block">
                ...
                <a 
                    href="https://instagram.com/heartsocceragent" 
                    target="_blank" 
